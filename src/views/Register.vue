    ...
    <div class="reg_body">
        ...
        <div class="log">
            <div class="content1">
                <h2>登录</h2>
                <form>
                    <label for="login_name"></label><input
                        id="login_name"
                        autocomplete="on"
                        type="text"
                        name="userid"
                ...
                />
                    <label for="login_pw"></label><input
                        id="login_pw"
                        autocomplete="on"
                        type="password"
                        name="psw"
            ...
            <div class="content2">
                <h2>注册</h2>
                <form>
                    <label for="reg_name"></label><input
                        id="reg_name"
                        autocomplete="on"
                        type="text"
                        name="userid"
    ...
    export default {
        methods: {
            login() {
                ...
                let form_username = window.$("#login_name").val();
                let form_password = window.$("#login_pw").val();
                        ...
                        if (response) {
                            ...
                            if (window.localStorage.getItem("token")) {
                                ...
                                Axios.get(get_profile_url, {})
                                    .then(response => {
                                        const user_profile = JSON.stringify(response.data);
            ...
            register: function () {
                let router = this.$router;
                let form_username = window.$("#reg_name").val();
                let form_password = window.$("#reg_pw").val();
                let form_role = window.$("#reg_role").val();
                ...
                Axios.post("http://127.0.0.1:8000/User/register/", {
                    ...
                    .then(function (response) {
                        ...
                        if (response.status === 200) {
                            ...
                            const get_profile_url = "http://127.0.0.1:8000/User/get_profile/";
                            const user_token = data.token.access;
